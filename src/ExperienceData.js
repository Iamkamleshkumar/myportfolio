...
const ExperiencesData = [
  {
    id: "Blaccsckull Platforms Private Limited",
    job: "Software Developer",
    img: tetra,
    Type: "",
    date: "Aug. 2022 - Jan. 2023",
    stack: ["React.js | Express.js| Nodejs | SQLite | MongoDB | Figma "],
    name: "Blaccsckull Platforms Private Limited",
    location: "Agra,UP,India",
    live: "",
    source: "",
    colour: "#3edd8e",
    description1: 
    "Implemented a comprehensive Full-Stack application using Reactjs for the frontend, Node.js for the backend, and SQLite or MongoDB for the database, used as the tool to interact with users and create events",
    description2:
  ...
  {
    id: "Omikron Technologies Private Limited.",
    job: "Software Developer",
    img: Salumatics,
    Type: "Internship",
    ...
    source: "",
    description1: 
    "Developed a highly efficient and maintainable PHP web application used as the primary tool for business sales, by utilizing my expertise in PHP, JS/jquery, HTML, and CSS resulting in a significant 40% increase in sales",
    description2:
